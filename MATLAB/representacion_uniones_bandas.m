function representacion_uniones_bandas(freq, ep_real, ep_imag, mu_real, mu_imag, mu_interp, ep_interp, n2, amp_max_n2, amp_min_n2, ...
    ...
    sombra_y(sombra_ini:sombra_fin) = ep_real(sombra_ini:sombra_fin);
    area(freq, sombra_y,'FaceColor','b','FaceAlpha',.3,'EdgeAlpha',.3)
    sombra_y(sombra_ini:sombra_fin) = ep_imag(sombra_ini:sombra_fin);
    area(freq, sombra_y,'FaceColor','r','FaceAlpha',.3,'EdgeAlpha',.3)
    hold off
    ...
    sombra_y(sombra_ini:sombra_fin) = mu_real(sombra_ini:sombra_fin);
    area(freq, sombra_y,'FaceColor','b','FaceAlpha',.3,'EdgeAlpha',.3)
    sombra_y(sombra_ini:sombra_fin) = mu_imag(sombra_ini:sombra_fin);
    area(freq, sombra_y,'FaceColor','r','FaceAlpha',.3,'EdgeAlpha',.3)
    hold off
    ...
    hold on
    sombra_y(sombra_ini:sombra_fin) = n2(sombra_ini:sombra_fin);
    area(freq, sombra_y,'FaceColor','b','FaceAlpha',.3,'EdgeAlpha',.3)
    hold off
